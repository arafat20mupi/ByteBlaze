...
const Navbar = () => {
    ...
    return (
        <div className="navbar shadow-lg sm:px-10 ">
            <div className="flex-1">
                <a className="btn btn-ghost text-2xl text-secondary font-bold gap-0">Byte<span className="text-primary">Blaze</span></a>
            </div>
            <div className="flex-none">
                <ul className="text-lg font-medium flex gap-3">
                ...
                <label onChange={ToggleTheme} className="cursor-pointer ml-2 grid place-items-center">
